...
function addBookToLibrary(ev) {
  // record values in form textboxes, generate new book object with values
  ev.preventDefault();
  const inputs = Array.from(
    document.querySelectorAll("#bookForm input")
...
function display() {
  // loop through book objects in array and add html element for each
  ...
  myLibrary.forEach((book) => {
    ...
    displayBook.innerHTML = `
            ...
            <div class="card-body">
                ...
                <button class="toggle-read-btn" onclick="toggleRead(${myLibrary.indexOf(
                  book
                )})">Toggle Read</button>
            </div>
        `;
